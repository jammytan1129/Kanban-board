...
const work_item1 = {
    ...
    todo_list: [
        {is_done: true, content: "專案規劃及查核"},
        {is_done: true, content: "專案成員工作指派 (Personnel)"},
        {is_done: true, content: "資源需求 (Resources)"},
        {is_done: true, content: "風險評估 (Risk Management)"},
        {is_done: true, content: "建構管理計畫 (Configuration Management Plan)"},
        {is_done: true, content: "度量與分析計畫 (Measurement and Analysis Plan)"},
        {is_done: true, content: "流程與產品品質保證計劃 (PPQA Plan)"}
    ],
    comments: [
        {
            user_id: 2,
...
const work_item2 = {
    ...
    todo_list: [
        {is_done: true, content: "簡介"},
        {is_done: true, content: "系統"},
        {is_done: true, content: "看板子系統"},
        {is_done: true, content: "使用者及團隊管理子系統"},
        {is_done: true, content: "報表產生與管理子系統"}
    ],
    comments: [
        {
            user_id: 0,
...
const work_item3 = {
    ...
    todo_list: [
        {is_done: true, content: "註冊即登入畫面"},
        {is_done: true, content: "看板畫面及卡片拖拉"},
        {is_done: true, content: "工作項目編輯畫面"},
        {is_done: true, content: "成員管理"},
        {is_done: true, content: "多個看板畫面"}
    ],
    comments: [
        {
            user_id: 2,
